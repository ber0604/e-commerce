                ...
                <form class="needs-validation" novalidate>
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="firstName" placeholder="João da Silva"
                                value="" required>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="username" placeholder="000.000.000-00"
                                    required>
                                <div class="invalid-feedback">
                                    000.000.000-00
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="address" placeholder="(00) 00000-0000"
                                required>
                            <div class="invalid-feedback">
